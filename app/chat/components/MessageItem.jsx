    ...
    if (urlRegex.test(part)) {
      ...
      return (
        <a
          ...
          className={`underline hover:no-underline transition-all duration-200 break-words message-content ${
            isUserMessage 
            ...
            <div className="mb-2 group relative">
              ...
              {message.attachments.map((attachment, index) => (
                attachment.isUploading ? (
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-md p-3">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium text-gray-900 break-words" style={{ wordBreak: 'break-word', overflowWrap: 'break-word' }}>
                            {attachment.filename}
                          </p>
                          <p className="text-xs text-gray-500 break-words" style={{ wordBreak: 'break-word', overflowWrap: 'break-word' }}>
                  ...
                  <div
                    key={index}
                    className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-gray-50 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors"
                  ...
                  >
                    <div className="flex-shrink-0">
                      {attachment.type === "image" ? (
                        <img
                          ...
                          className="w-6 h-6 sm:w-8 sm:h-8 object-cover rounded border border-gray-200"
                          loading="lazy"
                        />
                      ) : attachment.type === "document" ? (
                        <div className="w-6 h-6 sm:w-8 sm:h-8 bg-orange-50 border border-orange-200 rounded flex items-center justify-center">
                        ...
                        <div className="w-6 h-6 sm:w-8 sm:h-8 bg-blue-50 border border-blue-200 rounded flex items-center justify-center">
                        ...
                        <div className="w-6 h-6 sm:w-8 sm:h-8 bg-green-50 border border-green-200 rounded flex items-center justify-center">
                        ...
                        <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gray-50 border border-gray-200 rounded flex items-center justify-center">
                    ...
                    <div className="flex-1 min-w-0 w-full">
                      <p className="font-medium text-gray-900 text-xs sm:text-sm break-words" style={{ wordBreak: 'break-word', overflowWrap: 'break-word' }}>
                        {attachment.filename}
                      </p>
                      <p className="text-xs text-gray-500 break-words mt-1" style={{ wordBreak: 'break-word', overflowWrap: 'break-word' }}>
