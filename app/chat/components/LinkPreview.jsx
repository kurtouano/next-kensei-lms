...
const LinkPreview = ({ url, className = "" }) => {
  ...
  return (
    <div 
      className={`bg-gray-50 border border-gray-200 rounded-lg overflow-hidden cursor-pointer hover:bg-gray-100 transition-colors shadow-sm w-full link-preview ${className}`}
    ...
    >
      ...
      {metadata.type === 'youtube' && (
        <div className="relative">
          ...
          <div className="p-2 sm:p-3">
            ...
            <p className="text-xs text-gray-600 mb-1 sm:mb-2 break-words overflow-hidden" style={{ maxWidth: '100%', wordBreak: 'break-word', overflowWrap: 'break-word' }}>
        ...
        <div className="p-2 sm:p-3">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3">
            ...
            <div className="flex-1 min-w-0 w-full">
              <h3 className="font-medium text-gray-900 text-xs sm:text-sm break-words" style={{ wordBreak: 'break-word', overflowWrap: 'break-word' }}>
                View on Twitter/X
              </h3>
              <p className="text-xs text-gray-600 break-words mt-1" style={{ wordBreak: 'break-word', overflowWrap: 'break-word' }}>
                Click to view the post
              </p>
            </div>
            <ExternalLink className="w-3 h-3 sm:w-4 sm:h-4 text-gray-400 flex-shrink-0 self-start sm:self-center" />
          </div>
        </div>
      )}
      ...
      {metadata.type === 'instagram' && (
        <div className="p-2 sm:p-3">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3">
            <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500 rounded-lg flex items-center justify-center flex-shrink-0">
              <svg className="w-3 h-3 sm:w-4 sm:h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          ...
          <div className="p-3">
            <div className="flex items-center gap-2 text-xs text-gray-500">
              ...
              <span className="truncate flex-1 overflow-hidden" style={{ maxWidth: '100%', textOverflow: 'ellipsis' }}>{metadata.description}</span>
              <ExternalLink className="w-3 h-3 flex-shrink-0" />
            </div>
          </div>
        </div>
      ...
      {metadata.type === 'link' && (
        <div className="p-2 sm:p-3">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 w-full" style={{ maxWidth: '100%' }}>
            ...
            <div className="flex-1 min-w-0 w-full">
              ...
              <p className="text-xs text-gray-600 break-words mt-1" style={{ maxWidth: '100%', wordBreak: 'break-word', overflowWrap: 'break-word' }}>
                {metadata.description}
              </p>
            </div>
            <ExternalLink className="w-3 h-3 sm:w-4 sm:h-4 text-gray-400 flex-shrink-0 self-start sm:self-center" />
