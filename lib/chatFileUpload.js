...
export const uploadChatAttachment = async (file) => {
  // Determine file type based on MIME type (videos and audio not allowed)
  ...
  if (file.type.startsWith('image/')) {
    ...
    throw new Error('Video and audio files are not allowed. Please upload images or documents only.')
  }
